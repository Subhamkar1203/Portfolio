...
export const metadata: Metadata = {
  title: "Subham Kar | AI Engineer & Full Stack Developer",
  description: "Cinematic portfolio of Subham Kar, building intelligent digital experiences through AI, Cloud, and Full Stack development.",
};
